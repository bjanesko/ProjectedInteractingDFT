...
Projected-interacting densty functional theory implemented in PySCF, including projected hybrids, local-hybrid-like self interaction, and projected-interacting full CI. 
...
Projected-interacting full CI introduce full exact exchange and full CI correlation into the projected states. 
...
LHSIC.py is a standalone routine to do local-hybrid-like self-interaction correction on a molecule described by a Gaussian formatted checkpoint file 
